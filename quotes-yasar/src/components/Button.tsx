...
// Not: Öğretmen "radix-ui" yazmış ama genelde kütüphane adı "@radix-ui/react-slot" şeklindedir. Hata verirse bunu düzeltmen gerekebilir.
...
function Button({
  ...
  size = "default",
  asChild = false,
  ...props // type, onClick, disabled gibi tüm HTML özellikleri bu paketin içindedir
}: ButtonProps) {
